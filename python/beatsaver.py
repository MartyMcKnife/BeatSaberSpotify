        ...
        try:
            ...
            for i in range(4):
                ...
                if correct > 70:
                    ...
                    self.logger.debug(
                        f"SongSubName is {songSubName}, SongAuthorName is {songAuthorName}"
                    )
                    if (
                        ...
                        if rating >= 0.7:
                            ...
                            print(
                                "Song: {0} has low rating. Skipping".format(track),
                                flush=True,
                            )
                    else:
                        print(
                            f"Song {songName}'s author on BeatSaver is not the same. Skipping",
                            flush=True,
                        )

            print(
                "Song: {0} not found. Falling back to BeatSage".format(track).encode(
                    "utf-8"
                ),
                flush=True,
            )
