...
namespace BeatSaberSpotify
{
    public partial class Form1 : Form
    {
        ...
        public void run_cmd(string cmd, string[] args, object sender)
        {
            ...
            process.StartInfo.Arguments = string.Format("\"{0}\" \"{1}\" \"{2}\" \"{3}\" \"{4}\" \"{5}\" \"{6}\" \"{7}\"", cmd, args[0], args[1], args[2], args[3], args[4], args[5], args[6]);
        ...
        private void lblHeadset_Click(object sender, EventArgs e)
        {
